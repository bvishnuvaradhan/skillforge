...
export const LoginForm = () => {
  ...
  const onSubmit = async (data: LoginInput) => {
    ...
    try {
      ...
      // Determine redirection based on onboardingComplete
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
        ...
        <div>
          <div className="flex justify-between items-center mb-1">
            <span className="text-xs text-brand-cyan hover:underline cursor-pointer">
              Forgot password?
            </span>
          </div>
          <Input
        ...
        <Button type="submit" variant="primary" className="w-full mt-2" isLoading={isLoading} loadingText="Signing in...">
          Sign In
        </Button>
      </form>
